...
namespace GCoM
{
    ...
    static const std::map<EUArchOp, EFUType> TuringOpFUMap
    {
        ...
        {EUArchOp::CALL_OPS, EFUType::SPECIALIZED_UNIT_1},
    ...
    private:
        ...
        int RunPerIntervalModel(unsigned intervalIdx, unsigned smConcurrentWarps, unsigned numActiveSM,
                CycleBreakdown &smCycleBreakdown);
